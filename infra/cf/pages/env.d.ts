/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv env.d.ts` (hash: b33d379133c3efb78f1657cf00b7233b)
// Runtime types generated with workerd@1.20250816.0 2024-12-30 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		AUDIT_FLUSH_INTERVAL: string;
		AUDIT_RETENTION_DAYS: string;
		NEON_PERSONAL_API_KEY: string;
		NEON_PROJECT_ID: string;
		NEON_BRANCH_ID: string;
		NEON_PARENT_BRANCH: string;
		NEON_COMUTES_PRIMARY: string;
		NEON_DATA_API: string;
		NEON_API_KEY: string;
		JWKS_URL: string;
		STACK_AUTH_PROJECT_ID: string;
		HYPERDRIVE: string;
		BOOKS_SERVICE: string;
