import { r as requireReact, S as ServerRouter, w as withErrorBoundaryProps, a as withHydrateFallbackProps, b as withComponentProps, c as ScrollRestoration, d as Scripts, O as Outlet, i as isRouteErrorResponse, u as useParams, L as Link, e as useLoaderData, f as useNavigate, g as useSearchParams } from "./index-CxdFjusJ.js";
import "node:events";
import "node:stream";
import "node:buffer";
...
const indexStylesHref = "/assets/index-0xWnSAs1.css";
function Layout({
  children
}) {
...
const HydrateFallback = withHydrateFallbackProps(function HydrateFallback2() {
...
function groupByGenre(books2) {
  ...
  return Object.entries(genresMap).map(([name, books3]) => ({
    name,
    count: books3.length,
    books: books3
...
function Sidebar({ genres = [], counts }) {
  ...
  const { genreId: genreId2 } = params;
  const activeGenre = genreId2 ? decodeURIComponent(genreId2) : null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "sidebar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sidebar-title", children: "Library" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "sidebar-nav", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-section", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sidebar-heading", children: "Genres" }),
        genres.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-2 text-sm text-gray-600", children: "Loading genres..." }) : genres.map((genre) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            ...
            children: [
              genre.name,
              counts && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-2 text-xs text-gray-900", children: [
                "(",
                genre.count,
                ")"
              ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-auto pt-6 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-gray-900", children: [
      "Powered by",
...
function MockDataBanner() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mock-data-banner", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "banner-content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Demo Mode: Using Mock Data" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "You're viewing this app with mock data. To connect to a real database:" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("ol", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Create a Hyperdrive binding in your wrangler.jsonc file." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: "https://github.com/cloudflare/templates/tree/main/react-router-postgres-ssr-template",
            target: "_blank",
            rel: "noopener noreferrer",
...
async function loader$3({
  ...
  try {
    ...
    if (!booksService) {
      console.warn("[Book Layout Loader] BOOKS_SERVICE binding not available, returning empty genres");
      return {
        genres: [],
        dataSource: "fallback"
      };
    ...
    const books2 = data.books || [];
    let genreGroups = [];
    if (books2.length > 0) {
      genreGroups = groupByGenre(books2);
    } else {
...
const bookLayout = withComponentProps(function BookLayout() {
  const {
    genres,
    dataSource
  } = useLoaderData();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ...
    children: [/* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, {
      ...
      children: [dataSource === "mock" && /* @__PURE__ */ jsxRuntimeExports.jsx(MockDataBanner, {}), /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {
        context: {
          genres
        }
      })]
...
function BookCard({ book, onClick }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "book-card cursor-pointer", onClick, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "book-card-image", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
        src: book.image_url,
        alt: book.title,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "book-card-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-serif mb-1 line-clamp-1", children: book.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-900 text-sm mb-2", children: [
        "by ",
        book.author
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-900 text-sm overflow-hidden line-clamp-3 mb-4", children: book.description }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-primary w-full text-sm font-bold", children: "Learn more" })
    ] })
  ] });
}
function BooksList({ books: books2 = [], onSelectBook }) {
  const navigate = useNavigate();
  const [searchParams, setSearchParams] = useSearchParams();
  const currentSort = searchParams.get("sort") || "";
  const handleBookSelect = (bookId2) => {
    onSelectBook ? onSelectBook(bookId2) : navigate(`/book/${bookId2}`);
  };
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "select",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "title_asc", children: "Title (A-Z)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "title_desc", children: "Title (Z-A)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "author_asc", children: "Author (A-Z)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "author_desc", children: "Author (Z-A)" })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: books2.map((book) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      BookCard,
      {
        book,
...
function Breadcrumbs({ items, onNavigate }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "breadcrumbs", children: items.map((item, index) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "breadcrumb-item", children: isLast ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "breadcrumb-current", children: item.label }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      linkTo ? /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: linkTo, className: "breadcrumb-link", children: item.label }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
...
async function loader$2({
  ...
  try {
    ...
    const booksService = context?.cloudflare?.env?.BOOKS_SERVICE;
    if (!booksService) {
      console.warn("[Books Loader] BOOKS_SERVICE binding not available, returning empty array");
      return {
        books: [],
        source: "fallback"
      };
    }
    console.log("[Books Loader] Calling books service", {
      genre,
      sort
    });
    const data = await booksService.getBooks({
...
const books = withComponentProps(function BooksRoot() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [/* @__PURE__ */ jsxRuntimeExports.jsx(Breadcrumbs, {
      ...
      children: [/* @__PURE__ */ jsxRuntimeExports.jsx("h1", {
        ...
        children: "Discover your next favorite book"
      })]
    }), /* @__PURE__ */ jsxRuntimeExports.jsx(BooksList, {
      books: data.books
    })]
  });
});
...
function BookDetail({ bookData }) {
  ...
  const handleRelatedBookClick = (bookId2) => {
    navigate(`/book/${bookId2}`);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Breadcrumbs, { items: breadcrumbItems, onNavigate: handleNavigate }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-12 mt-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:flex gap-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:w-1/3 lg:w-1/4 flex-shrink-0 mb-8 md:mb-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: book.image_url,
            alt: book.title,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:w-2/3 lg:w-3/4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mb-3", children: book.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-xl text-gray-900 mb-6 font-serif font-normal", children: [
            "by ",
            book.author
          ] }),
          book.genre && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-900 leading-relaxed", children: book.description })
        ] })
      ] }) }),
      relatedBooks.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-6", children: book.genre ? `Other Books in ${book.genre}` : "You May Also Like" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-5 gap-4", children: relatedBooks.map((relBook) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "card py-4 px-5 text-center cursor-pointer",
            onClick: () => handleRelatedBookClick(relBook.id),
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-32 mx-auto mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-serif text-gray-900 mb-1 line-clamp-1", children: relBook.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gray-900 text-sm font-sans", children: relBook.author })
            ]
          },
          relBook.id
        )) })
...
async function loader$1({
  ...
  try {
    ...
    const [bookData, relatedData] = await Promise.all([booksService.getBook(bookId2), booksService.getRelatedBooks(bookId2)]);
    ...
    if (relatedData.error || relatedData.status === 404) {
      throw new Response("Related books not found", {
        status: 404
      });
    }
    return {
    ...
    throw new Response("Error loading book details", {
      status: 500
    });
  }
}
const bookId = withComponentProps(function BookDetailRoute() {
  const bookDetail = useLoaderData();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(BookDetail, {
    bookData: bookDetail
  });
});
...
async function loader({
  ...
  try {
    const booksService = context?.cloudflare?.env?.BOOKS_SERVICE;
    if (!booksService) {
      console.warn("[Genre Loader] BOOKS_SERVICE binding not available, returning empty array");
      return {
        books: [],
        source: "fallback"
      };
...
const genreId = withComponentProps(function GenrePage() {
  const {
    genreId: genreId2
  } = useParams();
  const data = useLoaderData();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [/* @__PURE__ */ jsxRuntimeExports.jsx(Breadcrumbs, {
      ...
      children: [/* @__PURE__ */ jsxRuntimeExports.jsxs("h1", {
        children: [activeGenre, " Books"]
      }), /* @__PURE__ */ jsxRuntimeExports.jsxs("p", {
        className: "text-gray-900",
        children: ["Explore our collection of ", activeGenre.toLowerCase(), " books"]
      })]
    }), /* @__PURE__ */ jsxRuntimeExports.jsx(BooksList, {
      books: data.books
    })]
...
const serverManifest = { "entry": { "module": "/assets/entry.client-BQ_EMBE2.js", "imports": ["/assets/chunk-QMGIS6GS-zfQIRXjO.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": true, "module": "/assets/root-B-xJga5g.js", "imports": ["/assets/chunk-QMGIS6GS-zfQIRXjO.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "layouts/book-layout": { "id": "layouts/book-layout", "parentId": "root", "path": void 0, "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/book-layout-C3lLAn9d.js", "imports": ["/assets/chunk-QMGIS6GS-zfQIRXjO.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/books": { "id": "routes/books", "parentId": "layouts/book-layout", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/books-CvbQPxKE.js", "imports": ["/assets/chunk-QMGIS6GS-zfQIRXjO.js", "/assets/BooksList-DalTr1Ym.js", "/assets/Breadcrumbs-D3yHELiM.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/bookId": { "id": "routes/bookId", "parentId": "layouts/book-layout", "path": "book/:bookId", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/bookId-BtGvgJy3.js", "imports": ["/assets/chunk-QMGIS6GS-zfQIRXjO.js", "/assets/Breadcrumbs-D3yHELiM.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/genreId": { "id": "routes/genreId", "parentId": "layouts/book-layout", "path": "genre/:genreId", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/genreId-D90aZcdY.js", "imports": ["/assets/chunk-QMGIS6GS-zfQIRXjO.js", "/assets/BooksList-DalTr1Ym.js", "/assets/Breadcrumbs-D3yHELiM.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 } }, "url": "/assets/manifest-1fdf2803.js", "version": "1fdf2803", "sri": void 0 };
